...
var longestPalindrome = function (s) {
    ...
    for (let i = 0; i < s.length; i++) {
        let len1 = expandAroundCenter(s, i, i); // ex = aaeaa. - starts at e - odd length palindrome
        let len2 = expandAroundCenter(s, i, i + 1); // e= aabbaa - compair in pairs - even length palindrome
...
var longestPalindrome = function (s) {
    ...
    while (k <= n) {
        i = 0;
        // start,end pairs can be - [0,2] , [1,3], [2, 4] ....
